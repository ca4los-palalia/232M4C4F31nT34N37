...
public class AgregarPrecioProductoVM implements Serializable{
	private static final long serialVersionUID = 3098239433101641553L;
	@Wire("#agregarPrecioProductoModalDialog")
	...
	public void init(@ContextParam(ContextType.VIEW) Component view,
			...
			@ExecutionArgParam("itemFinder") Producto producto) {
		this.producto = producto;
		title = "Asignar precio al producto " + producto.getNombre();
		
		if(producto.getPrecioCompra() == null)
			descripcion = "recuerde Asignar el precio de compra de este producto para tener un mejor funcionamient en el sistema.";
